...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'atrás',
// Activity stream
    'CREATED_CONTACT' => 'ha creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'ha creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'ha creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'ha creado un <b>NUEVO</b> {0}', // For fusional (inflected) languages: used in sentence "Administrator created a new lead"
    'FOR' => 'para', // Activity stream for cases
    'FOR_AMOUNT' => 'para la cantidad de', // Activity stream for cases
