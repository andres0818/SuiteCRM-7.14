...
$mod_strings = array(
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Error de conexión de base de datos: El nombre de host de la base de datos proporcionado, el puerto, el nombre de usuario, y/o la contraseña no son válidos.',
    ...
    'LBL_DBCONF_DB_PORT' => 'Puerto de la base de datos',
    ...
    'LBL_APP_NOT_INSTALLED' => 'SuiteCRM no está instalado. El punto de entrada necesita un SuiteCRM instalado, por favor instale primero.',
    ...
    'LBL_SILENT_INSTALL_FAILED' => 'La instalación de SuiteCRM ha fallado.',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Ignorar advertencias de comprobación del sistema',
