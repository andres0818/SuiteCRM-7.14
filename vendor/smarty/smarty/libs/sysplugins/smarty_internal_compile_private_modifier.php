...
// Guarda la configuración actual de error_reporting
$previousErrorReporting = error_reporting();

// Ignora las advertencias de funciones deprecadas
            ...
            foreach ($modifier_types as $type) {
                switch ($type) {
                    ...
                    case 6:
                        ...
                        if (
                            isset($compiler->default_handler_plugins[Smarty::PLUGIN_MODIFIER][$modifier])
                            ...
                            if (
                                isset($compiler->required_plugins['nocache'][$modifier][Smarty::PLUGIN_MODIFIER]['file'])
                                ||
...
// Restaura la configuración original de error_reporting
